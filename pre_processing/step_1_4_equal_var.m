function matlabbatch = step_1_4_equal_var(subject, subj_files, scan_characteristics, measure_name)
...
%    matlabbatch{1}.spm.stats.factorial_design.globalm.glonorm = 2;    
    ...
    matlabbatch{1}.spm.stats.factorial_design.des.fblock.fac.variance = 0; %Unequal
