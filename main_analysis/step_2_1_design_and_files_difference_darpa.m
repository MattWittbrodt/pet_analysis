function matlabbatch = step_2_1_design_and_files_difference_darpa(subjects,analysis_files,subject_dir, analysis_type)
    
    % -----------------------------------------------------------
    % First, need to get a list of subject numbers and files for both ETI and non-ETI
    % -----------------------------------------------------------
